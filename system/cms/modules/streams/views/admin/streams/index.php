...
<table border="0" class="table-list" cellspacing="0">
	...
	?>
			...
			<td class="actions">
				<?php if(group_has_role('streams', 'admin_streams')): echo anchor('admin/streams/manage/' . $stream->id, lang('streams:manage'), 'class="button edit"'); endif; ?> 
				<?php echo anchor('admin/streams/entries/index/' . $stream->id, lang('streams:entries'), 'class="button edit"');?> 
				<?php echo anchor('admin/streams/entries/add/'.$stream->id, lang('streams:new_entry'), 'class="button green"');?> 
