...
<body>
    ...
    <footer class="clearfix">
        <div class="wrapper">
            <p class="credits">Copyright &copy;<?php echo date('Y'); ?> <a href="https://www.facebook.com/jeyson.garcia" target="_blank">Jeyson Garcia</a> &nbsp; <span><?php echo CMS_EDITION . ' Versión ' . CMS_VERSION; ?> &nbsp; Cargada en {elapsed_time} seg. Usando {memory_usage}.</span></p>
