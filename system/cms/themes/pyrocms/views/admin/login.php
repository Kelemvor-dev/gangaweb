    ...
    <body id="login-body">
        ...
        <footer id="login-footer">
            <div class="wrapper animated fadeIn" id="login-credits">
                Copyright &copy; 2013 - <?php echo date('Y'); ?> <a href="https://www.facebook.com/jeyson.garcia" target="_blank">Jeyson Garcia</a>
                <br><span id="version"><?php echo CMS_EDITION . ' Versión ' . CMS_VERSION; ?></span>
            </div>
        </footer>
    </body>
</html>