...
<div id="sortable">
            ...
            <section id="quick_links" class="item <?php echo isset($rss_items) ?>">
                <div class="content">
                    <ul>
                        ...
                        ?>
                        <li>
                            <a class="tooltip-s" title="Alertas" href="<?php echo site_url('admin/publications/listNotifications') ?>">
                                <div align="center" style="background: whitesmoke; border-radius: 8px; border: solid; border-width: 1px; border-color: #0000000a; padding-top: 19px; padding-bottom: 18px; padding-right: 13px; padding-left: 13px;">
                                    <i style="font-size: 52px;vertical-align: middle;color: lightgrey;"class="fa fa-bell" aria-hidden="true"></i>
                                    <i class="fa fa-circle-thin" style="position: absolute;font-size: 30px;margin: -70px 0px 0px 10px;color: #c11212;"></i>
                                    <span style="position: absolute;margin: -63px 0px 0px 19px;color: #c11212;font-weight: bold;"><?php echo $count ?></span>
                                </div>
                            </a>
                        </li>
                    </ul>
    ...
    <?php if (isset($recent_comments) AND is_array($recent_comments) AND $theme_options->pyrocms_recent_comments == 'no') : ?>
        <div class="one_full">
    ...
    <?php if ((isset($analytic_visits) OR isset($analytic_views)) AND $theme_options->pyrocms_analytics_graph == 'no'): ?>
    ...
    <!-- Begin RSS Feed -->
    <?php if (isset($rss_items) AND $theme_options->pyrocms_news_feed == 'no') : ?>
